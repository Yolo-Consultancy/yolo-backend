...
const env = {
  ...
  adminBootstrapEmail: process.env.ADMIN_BOOTSTRAP_EMAIL || "admin.vehicule@yolo.com",
  ...
  frontendUrl: process.env.FRONTEND_URL || process.env.ADMIN_URL || "http://localhost:4173",
